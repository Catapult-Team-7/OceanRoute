...
SeaSweep is a floating-debris response platform. The stack is a FastAPI backend plus a React/Leaflet operator dashboard built around a simple plan: predict debris, plan a route, and prove impact in one place. Forecasts combine:
