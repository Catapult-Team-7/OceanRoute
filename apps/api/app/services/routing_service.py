    ...
    if model.forecast_run_id:
        ...
        if linked_run is not None:
            forecast_provenance = build_forecast_provenance(
                ...
                requested_model_id=str(linked_run.summary.get("requested_model_id")) if linked_run.summary.get("requested_model_id") else None,
                resolved_model_id=str(linked_run.summary.get("resolved_model_id")) if linked_run.summary.get("resolved_model_id") else None,
                ...
                model_stage=str(linked_run.summary.get("model_stage")) if linked_run.summary.get("model_stage") else None,
